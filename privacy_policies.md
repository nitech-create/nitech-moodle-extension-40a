...
本プライバシーポリシーは、nitechCreate（以下、「当開発者」）が開発したGoogle Chromeの拡張機能(Extension)(以下、「拡張機能」とします。)の利用において、利用者の個人情報もしくはそれに準ずる情報を取り扱う際に、当開発者が遵守する方針を示したものです。
...
#### 取得方法
特定のWebサイトへアクセスした際に授業などの情報を取得する。
...
X: https://x.com/nitechCreate (DMやリプライ)
